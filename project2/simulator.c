    ...
    while (1) {
        ...
        /* FOR Rs */
            ...
            if (((opcode(state.EXMEM.instr) == ADD || opcode(state.EXMEM.instr) == NOR) 
                ...
                || (opcode(state.EXMEM.instr) == LW && field1(state.EXMEM.instr) != 0 
            ...
            /* if MEM hazard no EX hazard */
                ...
                || (opcode(state.MEMWB.instr) == LW && field1(state.MEMWB.instr) != 0 
            ...
            /* if WB hazard no EX, MEM hazard */
                ...
                || (opcode(state.WBEND.instr) == LW && field1(state.WBEND.instr) != 0 
